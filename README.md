...
This project uses [semantic versioning](https://semver.org) (x.y.z). That way, if the major version changes (e.g. 1.3.2 -> 2.0.0), you know the update might break any script you have that uses the older version of the data.
